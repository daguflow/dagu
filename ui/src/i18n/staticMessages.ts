...
const english = {
  ...
  'Pause': 'Pause',
  'Pause scheduled runs for every DAG? Manual, webhook, and sub-DAG runs keep working.': 'Pause scheduled runs for every DAG? Manual, webhook, and sub-DAG runs keep working.',
  ...
  'Please try again or check the server connection.': 'Please try again or check the server connection.',
  'Queued scheduled runs are dropped and catch-up windows are discarded. Nothing replays on resume.': 'Queued scheduled runs are dropped and catch-up windows are discarded. Nothing replays on resume.',
  'Resume': 'Resume',
  'Resume scheduled runs for every DAG? Schedules pick up from the next tick.': 'Resume scheduled runs for every DAG? Schedules pick up from the next tick.',
  'Resume Scheduler': 'Resume Scheduler',
  'Resume scheduler-driven run creation': 'Resume scheduler-driven run creation',
  'Resume the scheduler': 'Resume the scheduler',
  'Run progress': 'Run progress',
  'Run progress stack': 'Run progress stack',
  'Run output': 'Run output',
  'Scheduler is paused. No scheduled runs will start.': 'Scheduler is paused. No scheduled runs will start.',
...
const chinese = {
  ...
  'Loading run...': '正在加载运行...',
  'Pause': '暂停',
  'Pause scheduled runs for every DAG? Manual, webhook, and sub-DAG runs keep working.': '要暂停所有 DAG 的定时运行吗？手动、Webhook 和子 DAG 的运行不受影响。',
  'Pause Scheduler': '暂停调度器',
  'Pause scheduler-driven run creation': '暂停由调度器触发的运行',
  'Pause the scheduler': '暂停调度器',
  'paused by {user}': '由 {user} 暂停',
  'Please try again or check the server connection.': '请重试或检查服务器连接。',
  'Queued scheduled runs are dropped and catch-up windows are discarded. Nothing replays on resume.': '排队中的定时运行会被丢弃，追赶窗口也会被清除。恢复后不会重放。',
  'Resume': '恢复',
  'Resume scheduled runs for every DAG? Schedules pick up from the next tick.': '要恢复所有 DAG 的定时运行吗？调度将从下一个周期开始生效。',
  ...
  'Run output': '运行输出',
  'Scheduler is paused. No scheduled runs will start.': '调度器已暂停。不会启动任何定时运行。',
  Visualization: '可视化',
...
const japanese = {
  ...
  'Pause': '一時停止',
  'Pause scheduled runs for every DAG? Manual, webhook, and sub-DAG runs keep working.': 'すべての DAG のスケジュール実行を一時停止しますか？手動、Webhook、サブ DAG の実行は影響を受けません。',
  'Pause Scheduler': 'スケジューラを一時停止',
  'Pause scheduler-driven run creation': 'スケジューラによる実行の作成を一時停止します',
  'Pause the scheduler': 'スケジューラを一時停止',
  'paused by {user}': '{user} が一時停止',
  'Please try again or check the server connection.': '再試行するか、サーバー接続を確認してください。',
  'Queued scheduled runs are dropped and catch-up windows are discarded. Nothing replays on resume.': 'キュー内のスケジュール実行は破棄され、キャッチアップ期間も失われます。再開しても再実行されません。',
  'Resume': '再開',
  'Resume scheduled runs for every DAG? Schedules pick up from the next tick.': 'すべての DAG のスケジュール実行を再開しますか？次のティックからスケジュールが再開されます。',
  'Resume Scheduler': 'スケジューラを再開',
  'Resume scheduler-driven run creation': 'スケジューラによる実行の作成を再開します',
  'Resume the scheduler': 'スケジューラを再開',
  'Run progress': '実行の進捗',
  'Run progress stack': '実行の進捗スタック',
  'Run output': '実行出力',
  'Scheduler is paused. No scheduled runs will start.': 'スケジューラは一時停止中です。スケジュール実行は開始されません。',
  Visualization: '可視化',
